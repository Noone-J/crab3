 ...
 */
final class Version20240909120532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borne (id INT AUTO_INCREMENT NOT NULL, le_type_id INT DEFAULT NULL, la_station_id INT DEFAULT NULL, date_derniere_revision DATETIME NOT NULL, indice_compteur_unites INT NOT NULL, INDEX IDX_D7465BA5EA83FAE4 (le_type_id), INDEX IDX_D7465BA51BBF6E1 (la_station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE station (id INT AUTO_INCREMENT NOT NULL, la_maintenance_id INT DEFAULT NULL, libelle_emplacement VARCHAR(100) NOT NULL, INDEX IDX_9F39F8B145538E20 (la_maintenance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE technicien (id INT AUTO_INCREMENT NOT NULL, la_maintenance_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, INDEX IDX_96282C4C45538E20 (la_maintenance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
